$( document ).ready(function() {
    ...
    angular
        .module('app', ['$rootScope', '$location', 'AuthenticationService', 'FlashService', '$http', '$httpParamSerializer', '$cookies'])
         .config(
    ...
    //DashboardController.$inject = ['$rootScope', '$location', 'AuthenticationService', 'FlashService', '$http', '$httpParamSerializer', '$cookies'];
    function DashboardController($scope, $location, AuthenticationService, FlashService, $http, $httpParamSerializer, $cookies) {
        var vm = this;
